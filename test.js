...
async function main() {
    try {
        ...
        const model = genAI.getGenerativeModel({
            ...
            systemInstruction: `You are a translation engine specializing in corporate jargon.
    ...
    "We need to fix the website because it's slow."`
        ...
        const response = await model.generateContent("Translate to corporate consulting jargon: We need to fix the website because it's slow.");
